...
use App\Larinterface\Test\Interfaces\ThirdClassInterface;
use Closure;
use ArrayAccess;
use ReflectionClass;
 ...
 */
class ThirdClass extends AbstractClass implements DispatcherContract, QueueingDispatcher, ThirdClassInterface
{
    /**
